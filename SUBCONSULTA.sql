CREATE TABLE TIPO_CONTATO (
 ...
 SELECT * FROM FAMILIAR where grau_de_parentesco in ("PAI");
 SELECT * FROM DOENCA where descricao_doenca NOT IN ("Alzheimer");
 SELECT * FROM ESTADO where descricao_estado in ("SP");
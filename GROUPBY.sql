CREATE TABLE TIPO_CONTATO (
 ...
 SELECT * FROM CONTATO group by cod_tipocontat;
 SELECT * FROM ESTADO group by descricao_estado;
 SELECT * FROM BAIRRO group by descricao_bairro;
 SELECT * FROM PESSOA group by Sexo;
 SELECT * FROM PROFISSIONAL group by cargo;
